...
execute as @a if score @s warudo-timeLimit matches ..20 run scoreboard players set @s warudo-timeLimit 100
execute as @a if score @s warudo-coolTime matches ..20 run scoreboard players set @s warudo-coolTime 1200
