...
execute at @s run summon minecraft:egg ~ ~1 ~
execute as @e[type=#minecraft:arrows,limit=1,sort=nearest] at @s run tp @s ~ ~-0.5 ~ ~ ~
execute store result entity @e[type=egg,limit=1,sort=nearest] Motion[0] double 0.1 at @s run scoreboard players get @e[type=minecraft:armor_stand,name="destination",limit=1,sort=nearest] warudo-x
execute store result entity @e[type=egg,limit=1,sort=nearest] Motion[1] double 0.1 at @s run scoreboard players get @e[type=minecraft:armor_stand,name="destination",limit=1,sort=nearest] warudo-y
execute store result entity @e[type=egg,limit=1,sort=nearest] Motion[2] double 0.1 at @s run scoreboard players get @e[type=minecraft:armor_stand,name="destination",limit=1,sort=nearest] warudo-z
kill @s
